                                    ...
                                    @foreach($purchases as $purchase)
                                        <tr class="hideApprove{{$purchase->id}}">
                                            ...
                                            <td>
                                                ...
                                                @else
                                               	     <a style="font-size: 13px" name="approve" class="label label-success" onclick="approvAction({{ $purchase->id }});">Approve</a>
                                                     <a style="font-size: 13px" name="reject" class="label label-danger" onclick="rejectAction({{ $purchase->id }});">Reject</a>
                                               	@endif
                                            </td>
                                        </tr>
                                        <?php $x++;?>
